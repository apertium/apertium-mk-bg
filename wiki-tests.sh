...
wget -O - -q https://wiki.apertium.org/wiki/Macedonian_and_Bulgarian/$TESTTYPE | cleansrc > $SRCLIST;
wget -O - -q https://wiki.apertium.org/wiki/Macedonian_and_Bulgarian/$TESTTYPE | cleantrg > $TRGLIST;
